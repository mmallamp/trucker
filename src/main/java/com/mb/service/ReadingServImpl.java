...
import com.mb.exception.ReadingNotFoundException;
import com.mb.repository.AlertRepository;
import com.mb.repository.ReadingRepository;
...
@Service
public class ReadingServImpl implements ReadingService {
    ...
    @Autowired
    public ReadingServImpl(ReadingRepository repository, VehicleRepository vehicleRepository, AlertRepository alertRepository) {
